...
export default function MissionPage() {
  return (
    <div className="page-enter">
      {/* Our Story - full original text */}
      <section className="container-main pt-12 md:pt-16 pb-8">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-lg font-display font-medium mb-6" style={{ color: 'var(--color-text)' }}>Our Story</h2>
        ...
        <div className="text-center mt-12">
          <Link to="/about" className="text-xs font-semibold tracking-wider uppercase hover:opacity-70" style={{ color: 'var(--color-accent)' }}>&larr; Back to About</Link>
        </div>
      </section>
    </div>
  );
