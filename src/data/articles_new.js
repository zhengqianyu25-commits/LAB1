const articles = [
  ...
  },
  {
    ...
    body: [
      { "type": "image", "src": "media/child-stars/doc1.png", "alt": "The crew uses artificial tears during a crying scene to avoi", "caption": "The crew uses artificial tears during a crying scene to avoid forcing the child actor to cry emotionally. The method is intended to reduce psychological pressure on the young performer." },
      ...
      { "type": "image", "src": "media/child-stars/doc2.png", "alt": "Toys are prepared for the child actor before filming to help", "caption": "Toys are prepared for the child actor before filming to help him stay relaxed on set. The arrangement is part of an effort to make the filming process less stressful for children." },
      ...
      { "type": "image", "src": "media/child-stars/doc3.png", "alt": "Artificial tears help create a crying effect during the scen", "caption": "Artificial tears help create a crying effect during the scene without requiring the child actor to produce real emotional tears. The approach offers a more child-friendly alternative during filming." },
      ...
      { "type": "image", "src": "media/child-stars/doc4.png", "alt": "Crew members work with child actors during filming as the pr", "caption": "Crew members work with child actors during filming as the production team tries to balance shooting needs with child protection. The scene reflects the challenges of making productions safer for young performers." },
      { "type": "image", "src": "media/child-stars/doc5.png", "alt": "Staff members and child actors pose for a group photo at the", "caption": "Staff members and child actors pose for a group photo at the end of the child-friendly production experiment. The photo marks the completion of the project and its effort to explore safer filming practices for children." }
    ],
    ...
    media: {
      ...
      images: [
        { src: 'media/child-stars/photo1.png', alt: 'The crew uses artificial tears during a crying scene to avoi', caption: 'The crew uses artificial tears during a crying scene to avoid forcing the child actor to cry emotionally. The method is intended to reduce psychological pressure on the young performer.' },
        { src: 'media/child-stars/photo2.png', alt: 'Toys are prepared for the child actor before filming to help', caption: 'Toys are prepared for the child actor before filming to help him stay relaxed on set. The arrangement is part of an effort to make the filming process less stressful for children.' },
        { src: 'media/child-stars/photo3.png', alt: 'Artificial tears help create a crying effect during the scen', caption: 'Artificial tears help create a crying effect during the scene without requiring the child actor to produce real emotional tears. The approach offers a more child-friendly alternative during filming.' },
        { src: 'media/child-stars/photo4.png', alt: 'Crew members work with child actors during filming as the pr', caption: 'Crew members work with child actors during filming as the production team tries to balance shooting needs with child protection. The scene reflects the challenges of making productions safer for young performers.' },
        { src: 'media/child-stars/photo5.png', alt: 'Staff members and child actors pose for a group photo at the', caption: 'Staff members and child actors pose for a group photo at the end of the child-friendly production experiment. The photo marks the completion of the project and its effort to explore safer filming practices for children.' }
      ],
    },
  },
  {
