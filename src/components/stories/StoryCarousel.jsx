    ...
    <div className="relative overflow-hidden border mb-12" style={{ borderColor: 'var(--color-border)', borderRadius: '2px' }}>
      <div className="relative aspect-[2/1] md:aspect-[2.6/1] overflow-hidden">
        <Link to={`/article/${a.slug}`}>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-black/70 to-black/40 flex flex-col justify-end px-6 md:px-10 pb-10 md:pb-12">
            ...
            <div className="flex items-center gap-2 mt-4">
              {articles.map((_, i) => (
                <button key={i} onClick={(e) => { e.preventDefault(); setCurrent(i); }}
                  ...
                  style={{ width: i === current ? '20px' : '5px', height: '5px', background: i === current ? '#fff' : 'rgba(255,255,255,0.4)' }}
