      ...
      <section className="container-main pb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2 p-10 md:p-14 border" style={{ background: 'rgba(255,255,255,0.75)', borderColor: 'var(--color-border)' }}>
            ...
            <h3 className="text-2xl md:text-3xl font-display font-medium mb-4" style={{ color: 'var(--color-text)' }}>No Filter Lab</h3>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: 'var(--color-text-muted)' }}>
              From concert ticket scalping to stray animal rescue, every story is anchored with one core economic concept &mdash; no jargon, just clarity.
            </p>
          ...
          <div className="p-10 md:p-14 border flex flex-col justify-center" style={{ background: 'rgba(255,255,255,0.75)', borderColor: 'var(--color-border)' }}>
            ...
            <p className="text-sm leading-relaxed mb-4" style={{ color: 'var(--color-text-secondary)' }}>
              Six members. Six stories. Six site modules. A flat collaboration model with no editor-in-chief.
            </p>
