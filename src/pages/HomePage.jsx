    ...
    <div className="page-enter">
      ...
      <section className="container-main py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {moreStories.map((a) => {
            ...
            return (
              <Link key={a.slug} to={`/article/${a.slug}`} className="group border transition-all duration-300 hover:-translate-y-1 hover:shadow-md card-panel" style={{ borderColor: 'var(--color-border)', borderRadius: '3px', overflow: 'hidden' }}>
      ...
      <section className="container-main py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-8 md:p-10 border card-panel" style={{ borderColor: 'var(--color-border)', borderRadius: '2px' }}>
