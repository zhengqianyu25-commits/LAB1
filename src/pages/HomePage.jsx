  ...
  return (
    <div className="page-enter">
      ...
      <section className="container-main pb-24">
        <div className="p-10 md:p-14 border" style={{ background: 'rgba(255,255,255,0.75)', borderColor: 'var(--color-border)' }}>
          ...
          <p className="text-base leading-relaxed mb-3 max-w-2xl" style={{ color: 'var(--color-text-secondary)' }}>
