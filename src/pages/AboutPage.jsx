  ...
  return (
    <div className="page-enter">
      ...
      <section className="container-main pt-16 md:pt-20 pb-10 text-center">
        ...
        <h1 className="text-3xl md:text-5xl font-display font-medium mb-3" style={{ color: 'var(--color-text)' }}>No Filter Lab</h1>
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
          {[
            ...
            <div key={i} className="p-6 border" style={{ borderColor: 'var(--color-border)', borderRadius: '2px', background: 'rgba(255,255,255,0.7)' }}>
              ...
              <h3 className="text-sm font-display font-medium mb-2" style={{ color: 'var(--color-text)' }}>{item.title}</h3>
      ...
      <section className="container-main py-16">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-lg font-display font-medium mb-4" style={{ color: 'var(--color-text)' }}>Our Team</h2>
